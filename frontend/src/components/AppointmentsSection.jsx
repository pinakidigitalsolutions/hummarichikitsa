                ...
                return (
                  <div key={appointment._id} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden transition-all duration-200 hover:shadow-md">
                    ...
                    <div className="p-4">
                      ...
                      {showInactiveStatus && (
                        <div className="bg-amber-50 rounded-lg px-1 mb-3 border border-amber-100">
                          <p className="text-xs text-red-700 text-center">
                            Doctor is OFFLINE now, He is not actively looking for a patient please wait.
                          </p>
                        </div>
                      )}
                      ...
                      {!appointmentIsToday && showLiveStatus && (
                        <div className="bg-green-50 rounded-lg px-1 py-2 mb-3 border border-green-100">
                          <p className="text-xs text-green-700 text-center">
                            Doctor is ONLINE now, but your appointment is scheduled on <span className="font-bold">{new Date(appointment.date).toLocaleDateString('en-US', {
                            month: 'short',
                            day: 'numeric',
                            year: 'numeric'
                          })}</span>. Please wait until your appointment date.
                          </p>
                        </div>
                      )}
